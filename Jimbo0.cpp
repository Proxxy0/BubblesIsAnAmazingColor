...
double Jimbo::average(double *points, int numPnts){
  ...
  dt = (currT.tv_sec-prevT.tv_sec)
		+(currT.tv_usec-prevT.tv_usec)/1000000.0;
  prevT=currT;
  return mean;
}
...
void Jimbo::fireDrogue(){
  ...
  gettimeofday(&currT, NULL);
  float drogueT = dt = (currT.tv_sec-initT.tv_sec)
		+(currT.tv_usec-initT.tv_usec)/1000000.0;
  prevT=currT;
...
void Jimbo::fireMain(){
  ...
  gettimeofday(&currT, NULL);
  float mainT = dt = (currT.tv_sec-initT.tv_sec)
		+(currT.tv_usec-initT.tv_usec)/1000000.0;
  prevT=currT;
...
int Jimbo::endFlight(){
  gettimeofday(&currT, NULL);
  float totalT = dt = (currT.tv_sec-initT.tv_sec)
		+(currT.tv_usec-initT.tv_usec)/1000000.0;
  prevT=currT;
...
double Jimbo::getTotTime(){
  ...
  gettimeofday(&currT, NULL);
  float totT = dt = (currT.tv_sec-initT.tv_sec)
		+(currT.tv_usec-initT.tv_usec)/1000000.0;
  prevT=currT;
  return(totT)
}
